...
def walk():
  oled_display(openpibo.data_path+"icon/walk.png")
...
def weather():
  oled_display(openpibo.data_path+"icon/weather.png")
...
def dance():
  oled_display(openpibo.data_path+"icon/check.png")
...
def conversation(_text):
  print("대화:", _text)
  oled_display(openpibo.data_path+"icon/conversation.png")
  time.sleep(5)
...
if __name__ == "__main__":
  pibo.eye_on('aqua')
  oled_display(openpibo.data_path+"icon/pibo_logo.png")
  ...
  while True:
    if time.time() - start > 1:
      ...
      if ret['data']['TOUCH'] == 'touch':
        oled_display(openpibo.data_path+"icon/mic.png")
